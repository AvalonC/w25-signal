...
开场：把近处的主星拖向远方回应，也可直接轻触远方或使用键盘。接通之后进入愿望选择；三个愿望聚拢成伴星，再由玩家带光走进星路。声音可以主动开启，开关选择会在当前设备记住。
...
7. **回信与重访**：模型化为保持原轮廓的星点，再重排为 Project W25，停留后变成 HBD, Leah；三个愿望写进最后的祝福。声音开启时播放轻柔的生日旋律。按住文字至少 3 秒或轻触返回后，可以直接看手链与 AR、读生日回信、重温之前的选择，或选择新的愿望。
